...
<head>
    ...
    <link rel="stylesheet" href="{{asset("Content/css/fonts.css")}}">
    <link rel="stylesheet" href="{{asset("Content/css/style.css")}}">
    <link rel="stylesheet" href="{{asset("panel/css/style.css")}}">
    <link rel="stylesheet" href="{{asset("Content/css/responsive.css")}}" media="(max-width:991px)">
                   ...
                   <div style="width: 180px">
                       <div class="dropdown-select wide" id="dropdown-user" onclick="toggleUserDropdown()" tabindex="0" >
                        <span class="current">
                           ...
                           <div class="list">
                               <ul>
                                   <li class="option" data-value="0" data-display-text="" tabindex="0">پروفایل</li>
                                   <li class="option " data-value="0" data-display-text="" tabindex="0"> خروج</li>
                               </ul>
                           </div>
                       </div>
                   </div>
...
<script src="{{asset("Content/js/jquery-3.4.1.min.js")}}"></script>
<script src="{{asset("Content/js/js.js")}}"></script>
